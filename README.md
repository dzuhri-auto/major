...
MAJOR Telegram Mini App Bot Auto</br>
...
- Auto Clear Daily and Normal Tasks *(not all tasks)*
- Auto Play Games:
  - (Hold Coin, Swipe, Roulette) = Auto Play
  - Puzzle Durov = Manual via `puzzle.py` file
